...
export default function App() {
  ...
  useEffect(() => {
    ...
    const unsubCategories = subscribeToFirestoreCategories((liveCategories) => {
      if (Array.isArray(liveCategories)) {
        setCategories(liveCategories);
      }
    });

    const unsubPromotions = subscribeToFirestorePromotions((livePromotions) => {
      if (Array.isArray(livePromotions)) {
